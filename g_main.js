...
g_main.init = function () {
    ...
    //
    //window.focus(true);
    // I didn't know another way to make it work, so i just putted here
    // Since we need to initialize only once, if we initialize 
    // in the main update function it will just keep drawing on and on
    g_bricks.update();
